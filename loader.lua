...
if game.CreatorId == 123247 or game.PlaceId == 370731277 and continuee == true then
	local githublink = "https://raw.githubusercontent.com/windows10win7posreadywoeskio/mpcity/main/"
	local loaderurl = githublink .. "loader.lua"
	local uicheckurl = githublink .. "uicheck.lua"
	local scripturl = ""
	if identifyexecutor() == "Synapse X" or identifyexecutor() == "Fluxus" then
